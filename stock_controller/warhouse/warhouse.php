<!DOCTYPE html>
<html lang="en">
<?php include 'C:\xampp\htdocs\php\admin\admin\include\head.php' ?>
<?php include 'C:/xampp/htdocs/php/admin/admin/stock_controller/warhouse/index.php' ?>
...
<body class="hold-transition sidebar-mini">
				...
				<div class="container-fluid my-2">
					<div class="row mb-2">
						...
						<div class="col-sm-6 text-right">
							<a href="create.warhouse.php" class="btn btn-primary">New Page</a>
						</div>
					</div>
				</div>
			</section>
			<section class="content">
				<div class="container-fluid">
					<div class="card">
						...
						<?php include 'C:/xampp/htdocs/php/admin/admin/stock_controller/warhouse/number.php' ?>
					</div>
				</div>
			</section>
		</div>
	...
	<?php include 'C:/xampp/htdocs/php/admin/admin/include/footer.php' ?>
	<?php include 'C:/xampp/htdocs/php/admin/admin/stock_controller/warhouse/update.php' ?>
</body>
