...
<body class="hold-transition sidebar-mini">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
									...
									<?php if (mysqli_num_rows($category) > 0) { ?>
										...
										foreach ($category as $data) { ?>
											<tr>
												...
												<td>
													<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-danger category_delete" data-bs-toggle="modal" data-bs-target="#category_delete">
														Delete
													</button>
													<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-secondary category_update" data-bs-toggle="modal" data-bs-target="#category_update">
														Update
													</button>
												</td>
											</tr>
						...
						<?php include '../admin/stock_controller/category/number.php' ?>
					</div>
				</div>
			</section>
		</div>
	...
	<?php include '../admin/stock_controller/category/delete.php' ?>
	<?php include '../admin/stock_controller/category/update.php' ?>
	<?php include '../admin/stock_controller/category/function.php' ?>
</body>
</php>