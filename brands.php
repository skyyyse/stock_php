...
<body class="hold-transition sidebar-mini">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
									...
									<?php if (mysqli_num_rows($sql) > 0) { ?>
										...
										foreach ($sql as $data) { ?>
											<tr>
												...
												<td>
												<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-danger brand_delete" data-bs-toggle="modal" data-bs-target="#brand_delete">
														Delete
													</button>
													<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-secondary brand_update" data-bs-toggle="modal" data-bs-target="#brand_update">
														Update
													</button>
												</td>
											</tr>
						...
						<?php include '../admin/stock_controller/brands/number.php'?>
					</div>
				</div>
			</section>
		</div>
	...
	<?php include '../admin/stock_controller/brands/delete.php' ?>
	<?php include '../admin/stock_controller/brands/update.php' ?>
</body>
</php>