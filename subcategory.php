...
<?php include '../admin/stock_controller/subcategory/index.php' ?>
...
<body class="hold-transition sidebar-mini">
			...
			<section class="content">
				<div class="container-fluid">
					<div class="card">
									...
									<?php if (mysqli_num_rows($subcategory) > 0) { ?>
										...
										foreach ($subcategory as $data) { ?>
											<tr>
												...
												<td>
													<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-danger subcategory_delete" data-bs-toggle="modal" data-bs-target="#subcategory_delete">
														Delete
													</button>
													<button type="button" value="<?php echo $data['id'] ?>" class="btn btn-outline-secondary subcategory_update" data-bs-toggle="modal" data-bs-target="#subcategory_update">
														Update
													</button>
												</td>
											</tr>
						...
						<?php include '../admin/stock_controller/subcategory/number.php' ?>
					</div>
				</div>
			</section>
		</div>
	...
	<?php include '../admin/stock_controller/subcategory/delete.php' ?>
	<?php include '../admin/stock_controller/subcategory/update.php' ?>
</body>
